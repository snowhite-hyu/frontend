    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="flex w-full h-full justify-between items-center mt-[50px] px-[3%]">
                {/* 방 제목 */}
                <div className="rounded-[21px] bg-[#0000004D] w-[50%] h-[110px] pl-[40px] pt-[27px] mr-[38px]"><p className="font-semibold text-[43px]">빨리 오세요~</p></div>
                {/* 옵션 설정 */}
                <div className="flex justify-center items-center">
                    {options.map((option) => (
                        <div key="options" className="flex justify-center items-center mr-[28px]">
                            <Button
                                key={option.key}
